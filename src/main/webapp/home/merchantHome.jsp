  ...
  <div class="constructor">
    ...
    <div class="item item3">
      ...
      <div class="profile">
        ...
        <p class="profile-name">${merchant1.restaurantName}<i class="fa fa-ellipsis-v dots" aria-hidden="true"></i></p>
        ...
        <c:forEach items="${productList}" var="list">
          <tr>
            ...
            <td style="text-align: center;">
              <button class="ip-update" type="button" onclick="location.href='/products?action=update-product&id=${list.idProduct}'">
                <i class="fa fa-pencil"></i>
              </button>

              <button class="ip-delete" type="button" onclick="location.href='/products?action=delete-product&id=${list.idProduct}'">
