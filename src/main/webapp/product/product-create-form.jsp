...
<body>
<form class="form-horizontal" action="/products?action=createProduct" method="post">
  <fieldset>
    ...
    <%--                <input id="product_name_fre" name="product_address" placeholder="ADDRESS"--%>
    <%--                       class="form-control input-md" required="" type="text" value="${user.address}">--%>
    <%--            </div>--%>
    <%--        </div>--%>
    <div class="form-group">
